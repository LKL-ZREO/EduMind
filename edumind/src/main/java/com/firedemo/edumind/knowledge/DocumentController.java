...
import com.firedemo.edumind.live.GenerateMaterialsRequest;
import com.firedemo.edumind.live.GenerateMaterialsResponse;
import com.firedemo.edumind.platform.storage.FileStorage;
import com.firedemo.edumind.teaching.QuestionService;
import com.firedemo.edumind.teaching.PreviewTaskService;
...
import com.firedemo.edumind.live.service.TeachingMaterialGenerator;
...
public class DocumentController {
    ...
    public ResponseEntity<Map<String, Object>> uploadDocument(
        ...
        try {
            String docId = documentService.uploadDocument(userId, file, parentNodeId, kbId);
    ...
    public ResponseEntity<DocumentMaterialsDTO> listMaterials(@PathVariable String docId) {
        ...
        List<DocumentMaterialsDTO.PreviewSummary> previews = previewTaskService.listBySourceDocument(docId).stream()
