package com.firedemo.edumind.homework.grading.workflow;
...
public class GradingWorkflow {
    ...
    public GradingWorkflow(AgentService agentService,
                ...
                state -> {
                    ...
                    try {
                        ...
                        EvaluationResultDTO result = structuredOutputInvoker.invoke(
                                p -> agentService.chat(p, "grading_grade_" + state.getSubmissionId()),
                                prompt,
        ...
        wf.addNode(WorkflowNode.of(
                ...
                state -> {
                    ...
                    try {
                        ...
                        EvaluationResultDTO result = structuredOutputInvoker.invoke(
                                p -> agentService.chat(p, "grading_error_" + state.getSubmissionId()),
                                prompt,
                                EvaluationResultDTO.class,
        ...
        wf.addNode(WorkflowNode.of(
                ...
                state -> {
                    ...
                    try {
                        ...
                        EvaluationResultDTO result = structuredOutputInvoker.invoke(
                                p -> agentService.chat(p, "grading_sug_" + state.getSubmissionId()),
                                prompt,
                                EvaluationResultDTO.class,
