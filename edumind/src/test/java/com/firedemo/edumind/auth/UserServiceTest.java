...
/**
 * UserService 纯单元测试 — 只 Mock 依赖，不启动 Spring 上下文。
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("UserService — 用户服务")
class UserServiceTest {
    ...
    class Login {
        ...
        void setUp() {
            ...
            existingUser.setPassword(com.firedemo.edumind.auth.PasswordUtil.encode("correct-password"));
